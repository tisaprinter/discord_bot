...
def cmd(cmd, database=DATABASE['NAME'], value=None):
...
def get_value(target, database=DATABASE['NAME'], table="", search_filter=None, value=None, order=None, limit=None, arr=False):
    conn = mysql.connector.connect(
    host=DATABASE['HOST'],
    user=DATABASE['USER'],
    password=DATABASE['PASS'],
